(function () {
  ...
  function setupTangbao() {
    ...
    var messages = [
      ...
      "糖宝今天的小愿望：你们都有好好吃饭，也都有被好好惦记。",
      "遇到好笑的事情先存起来，等她有空，一起笑第二遍。",
      "今天的天空很好看，拍给她吧，顺便把想念也发过去。",
      "有空一起列张小清单吧，把想吃的、想看的都留给下次见面。",
      "糖宝想预约一次三个人的散步，两个人牵手，一只小狗带路。",
      "听不清的时候就再说一遍，喜欢和想念都不用怕重复。",
      "各自做事、偶尔抬头看一眼视频里的对方，也很像陪在身边。",
      "愿你们分享好消息时有人雀跃，说起小烦恼时有人认真听。",
      "不一定要聊很大的事情，今天路边开了什么花也值得分享。",
      "想送她的小礼物先记下来，糖宝可以帮忙保守惊喜的秘密。",
      "等下次见面，去走一段没走过的路，再拍一张新的合照吧。",
    ...
    var contextualMessages = {
      ball: [
        ...
        "小球滚到脚边啦，糖宝邀请你们暂时放下手机，伸个懒腰。",
        "这一球算糖宝的，下一球换你们来，快乐要轮流分享呀。",
        "糖宝叼着小球来找你啦，今天有什么开心的小事可以交换？",
        "等你们一起陪糖宝玩球，谁笑得最大声，谁就再陪一轮！"
      ],
      look: [
        "糖宝看过啦，你们站在一起的时候最好看！",
        "糖宝正在替你看看，她有没有也在想你呀。",
        ...
        "糖宝歪头看一看：今天有没有给喜欢的人留一句夸夸？",
        "窗外又换了一片云，糖宝想把它夹进你们下一封信里。",
        "糖宝站在这里望一会儿，替你们给下次散步挑个好天气。",
        "照片里的笑容看不够，就把新的合照也慢慢添进来吧。"
      ],
      sniff: [
        "糖宝闻到啦，空气里都是甜甜的想念。",
        ...
        "闻一闻，今天好像有晒过被子的味道，适合窝着聊聊天。",
        "糖宝沿着花香走了两步，想替你们找一条好看的散步路线。",
        "风把树叶吹响啦，像不像有人在轻轻说：今天也想你。",
        "糖宝的鼻尖收到春夏秋冬，想把每一种季节都分给你们。"
      ],
      rest: [
        ...
        "糖宝先趴一会儿，你们也把肩膀放松，慢慢呼一口气吧。",
        "今天没做完的事先记下来，休息的时候就放心休息。",
        "不想说话的时候也可以安静待着，陪伴不用每分钟都有台词。",
        "糖宝把旁边的位置留给你们，累了就来坐一小会儿。"
      ],
      celebrate: [
        "糖宝盖章：今天也在坚定地双向奔赴！",
        "喜欢被认真回应，是最值得庆祝的小事 ♡",
        ...
        "糖宝举起小爪子，为你们今天的一点点进步鼓掌！",
        "值得开心的事不用很大，一顿好吃的饭也可以庆祝呀。",
        "今天多说了一句谢谢、多给了一点耐心，糖宝都记下啦！",
        "糖宝的尾巴摇起来啦，快把这个好消息分享给喜欢的人！"
      ],
      food: [
        ...
        "糖宝先闻闻碗里的香气，你们今天有没有吃到喜欢的东西？",
        "把这家好吃的小店记下来，下次见面带对方再吃一次吧。",
        "糖宝的晚饭准备好啦，你们也别忙到忘记自己的那一份。",
        "今天学会一道新菜，等见面的时候，就多了一个小惊喜。"
      ],
      water: [
        ...
        "糖宝喝完水舔舔鼻尖，你们也从屏幕前抬头歇一会儿吧。",
        "水杯就在手边的话，陪糖宝一起喝两口，好不好呀？",
        "咕嘟一口，糖宝补充完毕，准备继续今天的小小巡逻！",
        "糖宝低头喝水，水面晃了晃，好像把窗外的云也喝进去啦。"
      ],
      morning: [
        ...
        "早安呀，先伸个懒腰，今天的故事还等着你们慢慢写。",
        "糖宝已经竖起小耳朵，等你们分享今天第一件开心事。",
        "早餐想吃什么？把这道小问题留给醒来的彼此吧。",
        "愿今天出门有好天气，忙完有好消息，回家有熟悉的问候。"
      ],
      daytime: [
        ...
        "糖宝来提醒一下：盯着屏幕很久的话，看看窗外再继续吧。",
        "午饭后留一点空闲，晒晒太阳，也给喜欢的人分享一张照片。",
        "正在忙的话就专心忙，想说的小故事可以先替彼此存着。",
        "今天完成的小事也值得打个勾，糖宝给你们各盖一枚爪印。"
      ],
      night: [
        ...
        "糖宝准备把耳朵收进梦里啦，你们也给今天一个温柔的结尾。",
        "睡前挑一件今天的小好事，讲给彼此听，再慢慢说晚安。",
        "消息可以等醒来再回，今晚先照顾好困困的自己。",
        "糖宝把今天的故事翻到书签那页，剩下的，明天接着讲。"
      ],
      click: [
        "叫糖宝有什么事呀，是不是又想她啦？",
        "糖宝在呢，你们的喜欢一直保管得好好的！",
        ...
        "小爪子收到啦！糖宝回赠一次贴贴，今天辛苦的你也有份。",
        "摸摸头可以，摸完要记得夸糖宝一句：今天也很乖！",
        "糖宝抬爪签到！今天想聊开心的，还是想让糖宝陪一会儿？",
        "又见到你啦，糖宝给你留了一小块晒得到太阳的位置。",
        "本次摸摸附赠小任务：想一件下次见面要一起做的事。",
        "糖宝凑过来啦，先陪你坐一会儿，不着急说话也没关系。",
        "收到摸摸，尾巴已启动！有好心情的话，也分给她一点吧。",
        "糖宝今天营业中，提供歪头、抬爪，还有认真听你说话。"
      ]
    };
    var recentMessages = [];
    ...
    function animationNow() {
      return (pausedAt === null ? window.performance.now() : pausedAt) - pausedDuration;
    }

    function armTimer(timer) {
      if (pausedAt !== null || document.hidden) return;
      timer.nativeId = window.setTimeout(function () {
        timer.nativeId = null;
        if (pausedAt !== null || document.hidden) return;
        timers.delete(timer.id);
        timer.callback();
      }, Math.max(0, timer.dueAt - animationNow()));
    }

    function scheduleTimer(callback, delay) {
      var timer = { id: ++nextTimerId, callback: callback, dueAt: animationNow() + delay, nativeId: null };
    ...
    var frameStartedAt = animationNow();
    ...
    var actionDefinitions = {
      ...
      "is-action-celebrate": { frames: [22, 30, 31, 30, 31, 30, 22], frameDuration: 185, loop: false, minimum: 1650, maximum: 1900 },
    ...
    function revealMessage(context) {
      ...
      cancelTimer(bubbleTimer);
      var readingTime = Math.min(7600, Math.max(5000, Array.from(bubble.textContent).length * 165));
      bubbleVisibleUntil = animationNow() + readingTime;
      bubbleTimer = scheduleTimer(function () {
    ...
    function speak() {
      cancelTimer(speechPoseTimer);

      if (reducedMotion || !framesReady || !sceneStarted) {
        revealMessage("click");
        return;
      }

      cancelTimer(actionTimer);
      cancelTimer(speechCueTimer);
      sceneQueue = [
      ...
      if (actionDefinitions[currentAction] && actionDefinitions[currentAction].moving) {
        ...
        speechPoseTimer = scheduleTimer(runNextSceneStep, 680);
      } else {
        runNextSceneStep();
      }
    }
    ...
    function applyAction(action) {
      ...
      if (definition.moving) {
        ...
        turnFlipTimer = scheduleTimer(function () {
    ...
    function runNextSceneStep() {
      ...
      var speechTimeRemaining = bubbleVisibleUntil - animationNow();
      if (upcomingDefinition.moving && tangbao.classList.contains("is-speaking") && speechTimeRemaining > 100) {
        actionTimer = scheduleTimer(runNextSceneStep, speechTimeRemaining + 60);
        return;
      }
      ...
      if (speechContext && Math.random() < speechChance) {
        speechCueTimer = scheduleTimer(function () { revealMessage(speechContext); }, step.speechDelay || 360);
      }

      actionTimer = scheduleTimer(runNextSceneStep, stepDuration(step));
    }
    ...
    function move(currentTime) {
      ...
      if (frameStepDistance > 0) {
        ...
        var elapsedFrames = Math.floor(Math.max(0, animationNow() - frameStartedAt) / frameDuration);
